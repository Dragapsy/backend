INSERT INTO users (id, pseudo, email, password, role, created_at) VALUES
  (1, 'Auteur', 'auteur@storyngo.dev', '$2a$10$7EqJtq98hPqEX7fNZaFWoOa5I3Q9wQJxRrHf1YtX7JdYz4aP1u3lK', 'USER', CURRENT_TIMESTAMP),
  (2, 'Lecteur', 'lecteur@storyngo.dev', '$2a$10$7EqJtq98hPqEX7fNZaFWoOa5I3Q9wQJxRrHf1YtX7JdYz4aP1u3lK', 'REVIEWER', CURRENT_TIMESTAMP),
  (3, 'Voter1', 'voter1@storyngo.dev', '$2a$10$7EqJtq98hPqEX7fNZaFWoOa5I3Q9wQJxRrHf1YtX7JdYz4aP1u3lK', 'USER', CURRENT_TIMESTAMP),
  (4, 'Voter2', 'voter2@storyngo.dev', '$2a$10$7EqJtq98hPqEX7fNZaFWoOa5I3Q9wQJxRrHf1YtX7JdYz4aP1u3lK', 'ADMIN', CURRENT_TIMESTAMP);

INSERT INTO stories (id, title, summary, created_at, author_id, status) VALUES
  (1, 'Royaume des Brumes', 'Fantasy : un royaume oublie se reveille.', CURRENT_TIMESTAMP, 1, 'DRAFT'),
  (2, 'Nuit Sans Fin', 'Horreur : une ville plongee dans l''ombre.', CURRENT_TIMESTAMP, 1, 'DRAFT');
